...
HMM_MODEL_PATH = os.path.join(os.path.dirname(__file__), 'ckpts/hmm.pkl')
CRF_MODEL_PATH = os.path.join(os.path.dirname(__file__), 'ckpts/crf.pkl')
BiLSTM_MODEL_PATH = os.path.join(os.path.dirname(__file__), 'ckpts/bilstm.pkl')
